...
pub use compute::{
    planned_ntt_cache_metrics, prewarm_ntt_requirements, BalancedDigitChunk, BalancedDigitRequest,
    BatchDecomposeFoldOutcome, CommitBackendFor, CommitCluster, ComputeBackendSetup,
    ComputeExecutionDomain, CpuBackend, CpuPreparedSetup, CyclicRowsComputeBackend,
    DecomposeFoldChunk, DecomposeFoldChunkSink, DigitRowsComputeBackend, DigitRowsProducts,
    LevelProveStacks, NttCacheOwnerId, NttExecutionRequirements, NttOperationCluster,
    NttPrewarmPhase, OpeningCluster, OpeningProveBackendFor, OperationCtx,
    PlannedNttCacheOwnerMetric, PreparedCrtNttProfile, PreparedNttCacheMetric, ProveFlowBackendFor,
    ProveStackFor, ProverComputeStack, RecursiveProveBackend, ReleaseRootNttAfterFold,
    RingSwitchCluster, RingSwitchProveBackend, RingSwitchRelationRows, RootCommitSource,
    RootFoldNttPrewarm, RootOpeningSource, RootPolyMeta, RootPolyShape, RootProveBackend,
...
pub use protocol::sumcheck::{
    ...
    DirectLinearSource, DirectRelationRangePreparationInput, DirectRelationRangeProofBackend,
    DirectRelationRangeProofState, DirectRelationTwoRoundPrefixData,
    DirectRelationTwoRoundPrefixState, DirectSparseLinearSource, LowBasisRangeCheckProver,
