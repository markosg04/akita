...
pub use compute::{
    ...
    CpuPreparedSetup, CyclicRowsComputeBackend, DecomposeFoldChunk, DecomposeFoldChunkSink,
    DigitRowsComputeBackend, DigitRowsProducts, LevelProveStacks, NttCacheOwnerId,
...
pub use protocol::sumcheck::{
    ...
    DirectRelationTwoRoundPrefixData, DirectRelationTwoRoundPrefixState, DirectSparseLinearSource,
    LowBasisRangeCheckProver, RelationRangeImageProver,
};
pub use protocol::{
