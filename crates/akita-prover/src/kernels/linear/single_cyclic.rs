...
#[tracing::instrument(skip_all, fields(num_rows = num_rows, num_cols = num_cols), name = "mat_vec_mul_ntt_single_i8")]
...
#[tracing::instrument(skip_all, fields(num_rows = num_rows, num_cols = num_cols), name = "mat_vec_mul_ntt_single_i8_cyclic")]
