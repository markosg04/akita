...
pub use proof::{
    ...
    ExtensionOpeningReductionShape, FoldLevelProof, LevelProofShape, MatrixElementDeriver,
    ...
    SetupProductSumcheckShape, SetupSumcheckProof, SharedSetupMatrix, TailSegmentGroupLayout,
