...
pub enum MetalOneHotKernel {
    ...
    /// Exact fp128 D512 panels with uniform sign-quadrant specialization.
    PackedFp128D512SignQuadrants,
}
...
impl MetalRuntime {
    ...
    fn dispatch_packed_onehot_source<S: PackedLaneSource>(
        ...
        autoreleasepool(|| {
            ...
            Ok(DispatchOutcome {
                ...
                kernel: MetalOneHotKernel::PackedFp128D512SignQuadrants,
    ...
    fn encode_onehot(
        ...
        match kernel {
            ...
            MetalOneHotKernel::PackedFp128D512Panels
            | MetalOneHotKernel::PackedFp128D512SignQuadrants => unreachable!(),
        }
        Ok(())
    }
}
