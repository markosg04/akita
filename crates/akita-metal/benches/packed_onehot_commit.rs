...
mod implementation {
    ...
    fn report_metal_only(
        ...
        let gpu_ms = metrics
            ...
            .unwrap_or_else(|| "unavailable".into());
        println!(
            "AKITA_F128_METAL_RESULT workload={} samples={} backend_setup_ms={:.6} matrix_prepare_ms={:.6} metal_mean_ms={:.6} gpu_ms={} inner_total_ms={:.6} cpu_leg_ms={:.6} digit_rows_ms={:.6} compression_ms={:.6} matrix_bytes={} matrix_read_bytes={} lane_bytes={} lane_read_bytes={} output_bytes={} scratch_bytes={} hot_entries={} input_zero_copy={} matrix_cache_hit={} cpu_work_units={} metal_work_units={}",
            workload.name,
            metal_times.len(),
            milliseconds(backend_setup_time),
            milliseconds(matrix_prepare_time),
